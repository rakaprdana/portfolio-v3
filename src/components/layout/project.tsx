...
import Warehouse from "../../../public/image/Warehouse-Management.png";
  ...
  const data = [
    {
      ...
      link: "https://sevi-go-three.vercel.app/",
    },
    {
      src: MiniLibLP,
    ...
    },
    {
      src: Warehouse,
      title:
        "Warehouse Management: A Management Website for manage youre warehouse",
      alt: "Project",
      descriptions:
        "Warehouse Management is a web application built to optimize warehouse operations. The project leverages React, TypeScript, and TailwindCSS for the frontend. For the backend, it uses Express with TypeScript for efficient server-side functionality, while MongoDB serves as the database solution for secure and scalable data storage.",
      link: "https://warehouse-inventory-chi.vercel.app/",
    },
  ];
  return (
